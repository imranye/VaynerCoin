...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd61b394d0ae0100ccc5bb80fc283457ab84f9350b040f2b63d4876923eb4f364");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "I was ready to quit at 1am, but how you do one thing is how you do everything";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1508563160;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388035891;
        ...
        assert(block.hashMerkleRoot == uint256("0xa254f36a749f5fecd834d20b5d0339a667c9999b964b1c8f5253b9c98dc282e4"));
